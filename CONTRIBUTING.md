...
To make any changes to your existing git commit message, run the following command in your terminal:

```sh
$ git commit --amend
```

Once you are done editing your commit message, save it like you have done previously
