...
"""
SPDX-2.3 YAML document generator
"""
...
class SpdxYAML22(generator.Generate):
    def generate(self, image_obj_list: List[Image], print_inclusive=False) -> str:
        return get_spdx_from_image_list(image_obj_list, "YAML", "SPDX-2.3")

    def generate_layer(self, layer: ImageLayer) -> str:
        return get_spdx_from_layer(layer, "YAML", "SPDX-2.3")
